...
CREATE TABLE forum.users (
	...
	role forum.user_role NOT null default 'user'::forum.user_role,
...
CREATE UNIQUE INDEX idx_reactions_n ON forum.reactions USING btree (thread_id, user_id, r_type) WHERE (post_id IS NULL);
CREATE UNIQUE INDEX idx_reactions_nn ON forum.reactions USING btree (post_id, thread_id, user_id, r_type) WHERE (post_id IS NOT NULL)
